...
public class TaskPage extends BasePage
{
	...
	public void clickOnselectCustomerAndProject(String text)
	{
		webActionUtil.clickOnElement(selectCustomerAndProject);
	}
	
	public void clickOnselectTasks(String text)
	{
		webActionUtil.selectDropDownText(selectTasks, text);
	}
